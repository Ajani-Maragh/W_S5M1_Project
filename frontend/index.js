function moduleProject1() {
  ...
  authorAndDate.textContent = `${author} in ${date || 'an unknown date'} ` 
  widget1.appendChild(authorAndDate)
  ...
  const corporateP = document.createElement('p');
  corporateP.textContent = `We need to ${randomVerb1} our ${randomNoun1} ${randomAdverb1} in order to ${randomVerb2} our ${randomNoun2} ${randomAdverb2}.`;
  corporateWidget.appendChild(corporateP);
